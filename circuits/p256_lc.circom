...
template P256LinearCombination(n, k, b) {
    ...
    // (n,k) = (43, 6)
    // 2^255 * Gx = [5013155818324, 5653956830653, 1357089440655, 4985459479134, 7362399503982, 1028176290396]
    // 2^255 * Gy = [2185447106559, 2319789413632, 3837703653281, 6590333830457, 5404134177552, 1407546699851]
    var dummy2[2][k];
    dummy2[0][0] = 5013155818324;
    dummy2[0][1] = 5653956830653;
    dummy2[0][2] = 1357089440655;
    dummy2[0][3] = 4985459479134;
    dummy2[0][4] = 7362399503982;
    dummy2[0][5] = 1028176290396;

    dummy2[1][0] = 2185447106559;
    dummy2[1][1] = 2319789413632;
    dummy2[1][2] = 3837703653281;
    dummy2[1][3] = 6590333830457;
    dummy2[1][4] = 5404134177552;
    dummy2[1][5] = 1407546699851;
